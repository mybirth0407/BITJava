...
public class RequestHandler extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            consoleLog("connected from " + inetSocketAddress.getHostName() +
...
//            outputStream.write("\r\n".getBytes());
//            outputStream.write(
//                ("<h1>이 페이지가 잘 보이면 실습과제 SimpleHttpServer를 " +
//                    "시작할 준비가 된 것입니다.</h1>").getBytes("UTF-8"));
