...
<form action="/bitservlet/emaillist/EmailListServlet" method="post">
  <input type="hidden" name="in" value="insert">
...
<br>
<p>
  <a href="/bitservlet/emaillist/EmailListServlet">리스트 바로가기</a>
</p>
</body>
</html>
